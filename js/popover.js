// https://github.com/juggy/jquery-popover/blob/master/MIT-LICENSE.txt
...
$.fn.popover = function(options) {
  ...
  var showPopover = function(button) {
    ...
    // Calculate topOff
    topOff = (offset.top - buttonHeight*5) + buttonHeight + triangleSize;
    var diffHeight = docHeight - (topOff + triangleSize);
    if (diffHeight < 0){
      //resize the floater
    ...
    // Calculate leftOff
    leftOff = (offset.left + buttonWidth*2.25) + (buttonWidth - contentWidth)/2;
    var diffWidth = 0;
    if (leftOff < padding) {
